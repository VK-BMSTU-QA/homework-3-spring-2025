...
### 1. Начало создания кампании

![alt](image/5_01.png)

- [ ] При нажатии на кнопку "Создать кампанию" открывается форма выбора цели
- [ ] При выборе цели "Целевые действия" и нажатии "Продолжить" подсвечивается этап "Группы объявлений" синим кружком
- [ ] При выборе рекламного объекта "Сайт" корректно открывается форма, ранее введённые значения сохраняются

### 2. Настройка группы объявлений
...
- [ ] При вводе названия группы менее 3 символов появляется сообщение об ошибке и кнопка сохранения недоступна
- [ ] При вводе валидного названия (например, "Моя группа") и клике вне поля, данные сохраняются автоматически

#### География показа

- [ ] При развертывании блока "География показа" отображаются поля выбора страны, региона и города
- [ ] При вводе "Чувашская Республика" регион отображается в списке выбранных
- [ ] При выборе/удалении региона расчёт аудитории обновляется

#### Интересы и поведение

- [ ] При развертывании блока отображаются категории: "Интересы", "Ключевые фразы", "Сообщества", "Музыканты"
- [ ] При вводе "Мебель" и выборе категории "Мебель и интерьер" категория добавляется, расчёт аудитории обновляется

<p id="отмена-выделения">Отмена выделения</p>
![bug](image/5_2_01.png.png)
...
- [ ] Изменение состояния чекбоксов влияет на расчёт аудитории

#### Места размещения

- [ ] При отключении автоселекта становятся доступны чекбоксы "ВКонтакте", "Одноклассники", "Проекты VK", "РСЯ"
- [ ] Изменение настроек влияет на расчёт аудитории
- [ ] При нажатии "Продолжить" подсвечивается следующий этап — "Объявления"
...
- [ ] Каждый этап отображается в статусной строке: текущий этап — синий кружок, завершённые — галочки
- [ ] При возврате к предыдущему этапу и возврате назад все ранее введённые данные подгружаются корректно
- [ ] При обновлении страницы на любом этапе форма восстанавливается и данные не теряются
